...
> **Актуальная версия — `PLACEHOLDERS_GUIDE_v20.pdf`** (v20: все ассеты, VFX, звуки, картинки, анимации, UI; списки выгружены из Config). Этот файл — старый вариант, местами устарел (например, ассеты теперь можно класть в подпапки `Assets`).
