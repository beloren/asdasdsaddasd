...
--------------------------------------------------------------------------------
-- v20.30: ФОНЫ ЗА ТОВАРОМ (вращающиеся «лучи» позади иконки). Одна картинка
-- на тип — одинаковые в похожих товарах, чтобы не рябило.
--   Star — звезда · Burst — вспышка-звёздочка («мастхев») · Shine — блик ·
--   BlackLightning — вспышка чёрной молнии (самое редкое) · Spiral — спираль.
-- Если картинка не видна — это ID декали, а не картинки: вставьте ID в
-- ImageLabel.Image в Studio, он превратится в ID картинки — его и впишите.
Theme.Backdrops = {
	Star = 12363979054,
	Burst = 11037521497,
	Shine = 12939184502,
	BlackLightning = 16511623380,
	Spiral = 1233066225,
}
-- Какой фон у какой редкости/типа товара.
Theme.RarityBackdrop = {
	Common = "Shine", Uncommon = "Shine", Rare = "Star", Epic = "Burst", Legendary = "Burst",
	Mythic = "BlackLightning", Secret = "BlackLightning", Mystery = "Spiral",
	Money = "Burst",   -- деньги / «лучшая цена» в магазине
	Product = "Shine", -- обычные товары магазина
}
-- Не красить в цвет редкости (картинка уже своего цвета).
Theme.BackdropKeepColor = { BlackLightning = true }
