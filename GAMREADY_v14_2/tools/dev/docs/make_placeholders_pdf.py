...
DECOR_LOOK = {
    ...
    "Flowers3": "Ящик лаванды: длинный деревянный ящик ~3.2 × 1.4 стада, в нём два ряда стеблей с фиолетовыми колосками высотой ~1 стад.",
    "Flowers4": "Клумба с ромашками: кольцо из серых камней ~2.8 стада, внутри земля и 7 белых ромашек с жёлтой серединкой.",
...
TABLE(["Ассет", "Название в игре", "Что делает"], [
    ...
    for k in ["Flowers1", "Flowers2", "Flowers3", "Flowers4", "Bush1", "Bush2", "Bench", "StorageChest", "OreJar"] if k in cfg["Placeables"]["Decor"]
